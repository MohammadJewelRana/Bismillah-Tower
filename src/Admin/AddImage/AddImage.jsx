    ...
    return (
        ...
        <>
            <div className='float-right mt-4'>
                <button onClick={() => setAddImage(!addImage)} className="btn btn-primary ">
            ...
            <div className='mb-16 mt-20'>
                {
                    ...
                    <>
                        ...
                        <SectionTitle heading={'Add Image'} subHeading={'New  member contact information'}></SectionTitle>
                        ...
                        <div className="card md:ml-16  bg-base-100 md:w-10/12 shadow-xl">
                            <div className="card-body">
                                ...
                                <form onSubmit={handleSubmit(onSubmit)}>
                                    ...
                                    <div className='mb-6'>
                                        <label htmlFor="name" className="block text-white mb-2 text-xl ml-2">Title of the section :</label>
                                        <input type='text'
