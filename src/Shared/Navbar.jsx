...
const Navbar = () => {
    ...
    const navLinks = < >
        ...
        <li>   <NavLink to="/gallery" className={({ isActive, isPending }) => isPending ? "pending" : isActive ? "    border-b-2   border-b-white " : ""} > Gallery </NavLink>
        </li>
        <li><NavLink to="/fund" className={({ isActive, isPending }) => isPending ? "pending" : isActive ? "    border-b-2   border-b-white " : ""} > Fund </NavLink>
        </li>
        <li><NavLink to="/contact" className={({ isActive, isPending }) => isPending ? "pending" : isActive ? "    border-b-2   border-b-white " : ""} > Contact </NavLink>
        </li>
        <li><NavLink to="/fund" className={({ isActive, isPending }) => isPending ? "pending" : isActive ? "    border-b-2   border-b-white " : ""} > About US </NavLink>
        </li>
